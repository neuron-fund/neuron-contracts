...
contract ChainLinkPricerWBTC {
    ...
    address public constant asset = 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599;
    ...
    function setExpiryPriceInOracle(uint256 _expiryTimestamp, uint80 _roundId) external onlyBot {
        ...
        oracle.setExpiryPrice(asset, _expiryTimestamp, uint256(btcPrice));
    }
    ...
    function getPrice() external view returns (uint256) {
        ...
        require(btcPrice > 0, "ChainLinkPricer: price is lower than 0");
