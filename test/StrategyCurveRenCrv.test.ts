...
import { AxonVyper__factory, Controller__factory, FeeDistributor__factory, GaugesDistributor__factory, ICurveFi, ICurveFi2, ICurveFi3, IERC20, IERC20__factory, IStEth, IUniswapRouterV2__factory, IWETH__factory, MasterChef__factory, NeuronPool, NeuronPool__factory, NeuronToken__factory, StrategyCurveRenCrv__factory, StrategyFeiTribeLp__factory } from '../typechain'
import { assert } from 'chai'
import { CRV, REN_CRV, SUSHISWAP_ROUTER, WETH } from '../constants/addresses'
...
describe('Token', function () {
  ...
  it('Test StrategyCurveRenCrv', async function () {
    ...
    const strategyFactory = await ethers.getContractFactory('StrategyCurveRenCrv') as StrategyCurveRenCrv__factory
