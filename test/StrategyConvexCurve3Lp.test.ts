...
import { AxonVyper__factory, Controller__factory, FeeDistributor__factory, GaugesDistributor__factory, ICurveFi3, IERC20, IERC20__factory, IUniswapRouterV2__factory, IWETH__factory, MasterChef__factory, NeuronPool__factory, NeuronToken__factory, StrategyConvexCurve3Lp__factory } from '../typechain'
...
describe('Token', function () {
  ...
  it('Test StrategyConvexCurve3Lp', async function () {
    ...
    await controller.connect(strategist).withdrawAll(await strategy.want());
